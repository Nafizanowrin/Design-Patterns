//Task6-StrategyPattern

class StrategyPattern {
    public static void main(String[] args) {
        Context squareContext = new Context(new squareArea());
        System.out.println("Area of Square: " + squareContext.executeStrategy(3, 3));

        Context circleContext = new Context(new CircleArea());
        System.out.println("Area of Circle: " + circleContext.executeStrategy(3, 9));
    }
}
